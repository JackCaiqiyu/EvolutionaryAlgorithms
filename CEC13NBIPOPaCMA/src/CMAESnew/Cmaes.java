      ...
      //  cma.setBounds(Bounds.getUpperBound(F), Bounds.getLowerBound(F));
       ...
       // cma.writeToDefaultFilesHeaders(0); // 0 == overwrites old files
        ...
        while ((cma.getCountEval() < cma.options.stopMaxFunEvals) && (bestValue - bias.getBias(F) > cma.options.stopFitness)){
            ...
            Configuration.records.newRecord(cma.getBestFunctionValue() - bias.getBias(F), (int)cma.getCountEval());
        ...
        Configuration.records.newRecord(cma.getBestFunctionValue() - bias.getBias(F), (int)cma.getCountEval(), (int)cma.options.stopMaxFunEvals);
