...
public class CEC13Benchmark extends AllBenchmarks {
    ...
    public double f(double[] x) {
        ...
        if (init_flag) {
            ...
            File fpt = new File("Benchmark/src/CEC13-Benchmark/src/input_data/M_D" + nx + ".txt");//* Load M data *
            Scanner input = null;
            try {
            ...
            fpt = new File("Benchmark/src/CEC13-Benchmark/src/input_data/shift_data.txt");
            try {
                input = new Scanner(fpt);
            } catch (FileNotFoundException e) {
                System.out.println("\n Error: Cannot open input file for reading ");
