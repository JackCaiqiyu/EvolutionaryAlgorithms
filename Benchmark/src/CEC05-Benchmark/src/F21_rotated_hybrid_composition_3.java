...
//		dated March 8, 2005.
//
public class F21_rotated_hybrid_composition_3 extends test_func {
	...
	// Constructors
	public F21_rotated_hybrid_composition_3 (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F21_rotated_hybrid_composition_3 (int dimension, double bias, String file_data, String file_m) {
