...
public class F20_rotated_hybrid_composition_2_global_opt_bound extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Rotated Hybrid Composition Function 2 with Global Optimimum on the Bounds";
	static final public String DEFAULT_FILE_DATA =CEC05Benchmark.files +  "hybrid_func2_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "hybrid_func2_M_D";
	...
	// Constructors
	public F20_rotated_hybrid_composition_2_global_opt_bound (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F20_rotated_hybrid_composition_2_global_opt_bound (int dimension, double bias, String file_data, String file_m) {
