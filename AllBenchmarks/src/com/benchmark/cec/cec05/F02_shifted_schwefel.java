...
public class F02_shifted_schwefel extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Shifted Schwefel's Problem 1.2";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files +  "schwefel_102_data.txt";
	...
	// Constructors
	public F02_shifted_schwefel (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA);
	}
	public F02_shifted_schwefel (int dimension, double bias, String file_data) {
