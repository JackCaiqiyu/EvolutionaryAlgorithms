...
public class F25_rotated_hybrid_composition_4_bound extends test_func {
	...
	// Constructors
	public F25_rotated_hybrid_composition_4_bound (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F25_rotated_hybrid_composition_4_bound (int dimension, double bias, String file_data, String file_m) {
