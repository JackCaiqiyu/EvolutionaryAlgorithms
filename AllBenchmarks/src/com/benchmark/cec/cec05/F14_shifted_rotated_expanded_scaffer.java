...
public class F14_shifted_rotated_expanded_scaffer extends test_func {
	...
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "E_ScafferF6_func_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "E_ScafferF6_M_D";
