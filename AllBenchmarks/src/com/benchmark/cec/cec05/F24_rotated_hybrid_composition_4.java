...
public class F24_rotated_hybrid_composition_4 extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Rotated Hybrid Composition Function 4";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "hybrid_func4_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX =CEC05Benchmark.files +  "hybrid_func4_M_D";
	...
	// Constructors
	public F24_rotated_hybrid_composition_4 (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F24_rotated_hybrid_composition_4 (int dimension, double bias, String file_data, String file_m) {
