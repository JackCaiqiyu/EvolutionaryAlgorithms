...
public class F06_shifted_rosenbrock extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Shifted Rosenbrock's Function";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "rosenbrock_func_data.txt";
	...
	// Constructors
	public F06_shifted_rosenbrock (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA);
	}
	public F06_shifted_rosenbrock (int dimension, double bias, String file_data) {
