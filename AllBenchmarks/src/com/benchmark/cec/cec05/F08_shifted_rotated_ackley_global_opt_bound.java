...
public class F08_shifted_rotated_ackley_global_opt_bound extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Shifted Rotated Ackley's Function with Global Optimum on Bounds";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "ackley_func_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "ackley_M_D";
	...
	public F08_shifted_rotated_ackley_global_opt_bound (int dimension, double bias, String file_data, String file_m) {
