...
public class F23_noncontinuous_rotated_hybrid_composition_3 extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Non-Continuous Rotated Hybrid Composition Function 3";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "hybrid_func3_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX =CEC05Benchmark.files +  "hybrid_func3_M_D";
	...
	// Constructors
	public F23_noncontinuous_rotated_hybrid_composition_3 (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F23_noncontinuous_rotated_hybrid_composition_3 (int dimension, double bias, String file_data, String file_m) {
