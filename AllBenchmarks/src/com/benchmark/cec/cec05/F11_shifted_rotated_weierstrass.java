...
public class F11_shifted_rotated_weierstrass extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Shifted Rotated Weierstrass Function";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "weierstrass_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "weierstrass_M_D";
	...
	// Constructors
	public F11_shifted_rotated_weierstrass (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F11_shifted_rotated_weierstrass (int dimension, double bias, String file_data, String file_m) {
