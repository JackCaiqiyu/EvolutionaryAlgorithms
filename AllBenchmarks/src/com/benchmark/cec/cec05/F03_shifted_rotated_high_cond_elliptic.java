...
public class F03_shifted_rotated_high_cond_elliptic extends test_func {
	...
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "high_cond_elliptic_rot_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "Elliptic_M_D";
	...
	// Constructors
	public F03_shifted_rotated_high_cond_elliptic (int dimension, double bias) {
