...
public class F09_shifted_rastrigin extends test_func {
	...
	// Constructors
	public F09_shifted_rastrigin (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA);
	}
	public F09_shifted_rastrigin (int dimension, double bias, String file_data) {
