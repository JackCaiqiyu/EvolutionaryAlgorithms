...
public class F16_rotated_hybrid_composition_1 extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Rotated Hybrid Composition Function 1";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "hybrid_func1_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "hybrid_func1_M_D";
	...
	// Constructors
	public F16_rotated_hybrid_composition_1 (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
	}
	public F16_rotated_hybrid_composition_1 (int dimension, double bias, String file_data, String file_m) {
