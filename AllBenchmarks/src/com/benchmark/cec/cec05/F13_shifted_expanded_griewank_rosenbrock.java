...
public class F13_shifted_expanded_griewank_rosenbrock extends test_func {
	...
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "EF8F2_func_data.txt";
	...
	// Constructors
	public F13_shifted_expanded_griewank_rosenbrock (int dimension, double bias) {
		this(dimension, bias, DEFAULT_FILE_DATA);
	}
	public F13_shifted_expanded_griewank_rosenbrock (int dimension, double bias, String file_data) {
