...
public class F07_shifted_rotated_griewank extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Shifted Rotated Griewank's Function without Bounds";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files +  "griewank_func_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "griewank_M_D";
	...
	// Constructors
	public F07_shifted_rotated_griewank (int dimension, double bias) {
