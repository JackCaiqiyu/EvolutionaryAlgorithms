...
public class F22_rotated_hybrid_composition_3_high_cond_num_matrix extends test_func {
	...
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "hybrid_func3_HM_D";
	...
	public F22_rotated_hybrid_composition_3_high_cond_num_matrix (int dimension, double bias, String file_data, String file_m) {
