package com.benchmark.cec.cec05;// Special Session on Real-Parameter Optimization at CEC-05
...
public class benchmark {
	...
	static final public String DEFAULT_FILE_BIAS = CEC05Benchmark.files + "fbias_data.txt";
	...
	public test_func testFunctionFactory(int func_num, int dimension) {
		...
		try {
			...
			switch (func_num){
				case 1:
					returnFunc = new F01_shifted_sphere(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 2:
					returnFunc = new F02_shifted_schwefel(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 3:
					returnFunc = new F03_shifted_rotated_high_cond_elliptic(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 4:
					returnFunc = new F04_shifted_schwefel_noise(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 5:
					returnFunc = new F05_schwefel_global_opt_bound(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 6:
					returnFunc = new F06_shifted_rosenbrock(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 7:
					returnFunc = new F07_shifted_rotated_griewank(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 8:
					returnFunc = new F08_shifted_rotated_ackley_global_opt_bound(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 9:
					returnFunc = new F09_shifted_rastrigin(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 10:
					returnFunc = new F10_shifted_rotated_rastrigin(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 11:
					returnFunc = new F11_shifted_rotated_weierstrass(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 12:
					returnFunc = new F12_schwefel(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 13:
					returnFunc = new F13_shifted_expanded_griewank_rosenbrock(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 14:
					returnFunc = new F14_shifted_rotated_expanded_scaffer(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 15:
					returnFunc = new F15_hybrid_composition_1(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 16:
					returnFunc = new F16_rotated_hybrid_composition_1(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 17:
					returnFunc = new F17_rotated_hybrid_composition_1_noise(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 18:
					returnFunc = new F18_rotated_hybrid_composition_2(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 19:
					returnFunc = new F19_rotated_hybrid_composition_2_narrow_basin_global_opt(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 20:
					returnFunc = new F20_rotated_hybrid_composition_2_global_opt_bound(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 21:
					returnFunc = new F21_rotated_hybrid_composition_3(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 22:
					returnFunc = new F22_rotated_hybrid_composition_3_high_cond_num_matrix(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 23:
					returnFunc = new F23_noncontinuous_rotated_hybrid_composition_3(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 24:
					returnFunc = new F24_rotated_hybrid_composition_4(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				case 25:
					returnFunc = new F25_rotated_hybrid_composition_4_bound(new Integer(dimension), new Double(m_biases[func_num-1]));
					break;
				default:
					System.err.println("Function doesnt exist!");
					System.exit(0);
					break;
			}
		}
	...
	static public void loadTestDataFromFile(String file, int num_test_points, int test_dimension, double[][] x, double[] f) {
		try {
			READFILEJAR tmp = new READFILEJAR();
			BufferedReader brSrc = new BufferedReader(new FileReader(tmp.readFile(file)));
