...
public class F10_shifted_rotated_rastrigin extends test_func {

	// Fixed (class) parameters
	static final public String FUNCTION_NAME = "Shifted Rotated Rastrigin's Function";
	static final public String DEFAULT_FILE_DATA = CEC05Benchmark.files + "rastrigin_func_data.txt";
	static final public String DEFAULT_FILE_MX_PREFIX = CEC05Benchmark.files + "rastrigin_M_D";
	...
	// Constructors
	public F10_shifted_rotated_rastrigin (int dimension, double bias) {
